...
public class MemberService {
	...
	public void method1() {
		...
		memberArr[0] = new MemberDTO("member01", "pass01", "일번회원", 26);
		memberArr[1] = new MemberDTO("member02", "pass02", "회투", 30);
		memberArr[2] = new MemberDTO("member03", "pass03", "삼투", 34);
