...
public class StudentView {
	...
	private void addStudent() {
		...
		// StudentService 객체의 addStudent() 호출 후 결과 반환 받기
		 ...
		 *   단, 입력된 인덱스 가 0 미만 students 배열 마지막 인덱스
		 *  "인덱스 범위가 올바르지 않습니다."
		 * 
		 *   정상 범위 인덱스지만 학생이 존재하지 않는 경우
...
//			// 점수만 담는 용도의 StudentDTO 객체 생성
//			StudentDTO scores = new StudentDTO();
//			
//			scores.getHtml();
//			scores.getCss();
//			scores.getJs();
