...
public class PrintEx {
	public static void main(String[] args) {
		 ...
		 * 
		 * System.out.printf("템플릿", 사용 될 변수 | 값....);
		...
		System.out.println("이동현"); // 줄바꿈 O
		System.out.println("자바 재미없네."); // 줄바꿈 O
		...
		System.out.println(name + "은" + age + "세" + gender +"성으로" + "키는" + height + "이고," + "자바 공부 여부 : " + javaStudy);
		...
		// 문자열 6칸 오른쪽 정렬
		System.out.println(); //  줄바꿈
		System.out.printf("%6s/%f" , name, height); // ㅁㅁㅁ 홍길동 / 212.500000
		...
		double num = 1.25;
		System.out.println(); //  줄바꿈
		System.out.printf("%s/%.1f" , name, num); // ㅁㅁㅁ 홍길동 / 212.500000
