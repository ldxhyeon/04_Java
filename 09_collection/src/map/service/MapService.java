...
public class MapService {
	...
	public void test1() {
		...
		// - 추가 성공시 Value가 반환됨
		// -> 중복되는 key가 없으면 null
		// -> 중복되는 ket가 있으면 이전 value 반환
		
		System.out.println( map.put("아침", "참치 김밥"));
		System.out.println( map.put("점심", "순대 국밥"));
		System.out.println( map.put("저녁", "삼겹이"));
		System.out.println( map.put("저녁", "소고기"));
		// ket 중복 -> 이전 value를 내보내고 새 value로 대체
...
;
		...
		// 모아둔 key 집합에서
		// key를 하나씩 꺼내서 Map.get(hey)를 통해 value를 하나씩 꺼냄
