...
public class SetService {
	...
	public void test1() {
		...
		System.out.println("쿠팡제거 : " +  set.remove("쿠팡"));
	...
	public void test2() {
		...
		/* 1. Iterator(반복자) 이용 */
		// - 컬렉션 저장된 요소를 
		// 하나씩 순차 접근하는 기능을 제공하는 인터페이스
		
		// hasNext() : 다음 순차 접근할 요소가 있으면 true
		
		// next() : 다음 요소가 있으면 꺼내와서 반환해라
		//			-> 화살표(커서)를 한 칸 움직임
	 ...
	 * 		동등(equals)/동일(hashCode) 모두 true여야지만 동일한 객체로 인식한다.
	 * 
	 */
	public void test3() {
	 ...
	 * 
	 * ** 선행 조건 **
	 * - 저장되는 객체가 Comparable 인터페이스를 상속해 구현해야한다.
	 * 
	 */
	public void test4() {
