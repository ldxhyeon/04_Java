...
public class StudentService {
	 ...
	 */ 
		...
		// student 변수에는 생성된 Student 객체를 참조하는 주소 값 담겨있다.
		// -> 주소 값이 반환
		...
		public void studyHtml(Student std) {
			...
			int before = std.getHtml(); // 이전 점수 저장
			...
			// 기존 점수에 누적
			int temp = std.getHtml() + score; // 기존 점수 + 입력된 점수
