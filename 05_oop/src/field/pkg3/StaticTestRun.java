...
public class StaticTestRun {
	public static void main(String[] args) {
		...
		k1.setName("양심이");
		k1.setId("212323-2651551");
		
		Korean k2 = new Korean();
		k2.setName("개똥이");
		k2.setId("010-252952-5252");
...
//		k1.nationalCode = 10; // 불필요한 코드
		...
		// 왜 k1.nationalCode / k2.nationalCode에 왜 노란줄이 떠 있을까?
		...
		// ex) Math.PI (원주율)
		// 	   Interger.MAX_VALUE (int 최대값)
		// 	   Interger.MIN_VALUE (int 최소값)
